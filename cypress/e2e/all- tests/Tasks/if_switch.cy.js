...
context('Testing if, else and ?', () => {
  ...
  it('TESTS', () => {
    ...
    const isChild = (age >= 0 && age < 13) ? 'isChild' : 'notChild'
    const isTeen = (age >= 13 && age < 20) ? 'isTeen' : 'notTeen'
    const isAdult = (age >= 20 && age < 60) ? 'isAdult' : 'notAdult'
    const isSeniour = (age >= 60 && age < 120) ? 'isSenior' : 'notSenior'
