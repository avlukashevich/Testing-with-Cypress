context('Testing map', () => {
  it('TESTS', () => {
    ...
    const somePlanetsSet = new Set(['Mercury', 'Not Mercury', 'Mars'])
    for (const planet of somePlanetsSet) {
    ...
    const mergedPlanetsMaps = new Map([...planetsMap, ...newPlanetsMap])
